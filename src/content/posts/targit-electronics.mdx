...
<ImageGrid
    images={[[milledBoard, "a single sided PCB milled from a copper clad board.", "Single-sided milled prototype board."], [proBoard, "a PCB manufactured by OSHPark.", "Professionally manufactured board."], [stack, "a stack of TinyZero shields.", "TinyDuino stack."], [comparison, "A side by side view of the prototype board with the completed board.", "Completed prototype board alongside completed professional board."]]}
