...
<ClickableImage caption="Target architecture breakdown." captionMode="below" client:load imgSrc={labeledExplodedView.src}>
    <Image src={labeledExplodedView} alt="a labeled exploded view of the target subsytem CAD" />
</ClickableImage>
