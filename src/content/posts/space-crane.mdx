...
<ClickableImage caption={"Space Crane concept of operations (CONOPS)."} client:load>
...
<ImageGrid images={[[architecture, "Space Crane architecture."], [modularity, "Space Crane modularity."]]} caption="Space Crane architecture and modularity." rows="grid-rows-1" cols="grid-cols-2" clickable />
