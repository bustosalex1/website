...
<ClickableImage caption="Space Crane concept of operations (CONOPS)." imgSrc={conops.src} client:load captionMode="below">
    <Image src={conops} alt="concept of operations for a reusable lunar lander" />
</ClickableImage>
...
<ImageGrid images={[[architecture, "a labeled diagram of a concept lunar lander", "Space Crane architecture."], [modularity, "a labeled diagram of a concept lunar lander's different configurations" , "Space Crane modularity."]]} caption="Space Crane architecture and modularity." rows="grid-rows-1" cols="grid-cols-2" clickable />
