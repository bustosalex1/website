...
<ImageGrid images={[[architecture, "Space Crane architecture."], [modularity, "Space Crane modularity."]]} caption="Space Crane architecture and modularity." rows={2} cols={1} />
