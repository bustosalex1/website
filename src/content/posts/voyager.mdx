...
<ImageGrid
    images={[[saturnFlyby, "a single sided PCB milled from a copper clad board."], [saturnCloseup, "a PCB manufactured by OSHPark."], [jupiterFlyby, "a stack of TinyZero shields."], [jupiterCloseup, "A side by side view of the prototype board with the completed board."]]}
